...
#define encodedFileKEKRI "authEnvelopedDataKEKRI.der"
...
static int authEnvelopedData_encrypt(byte* out, word32 outSz)
{
    int ret;
    PKCS7* pkcs7;
    ...
    pkcs7->ukm             = NULL;
    pkcs7->ukmSz           = 0;
    pkcs7->authAttribs     = NULL;
    pkcs7->authAttribsSz   = 0;
    pkcs7->unauthAttribs   = NULL;
    pkcs7->unauthAttribsSz = 0;
...
static int authEnvelopedData_decrypt(byte* in, word32 inSz, byte* out,
                                     word32 outSz)
{
    int ret;
    PKCS7* pkcs7;
...
int main(int argc, char** argv)
{
    ...
    encryptedSz = authEnvelopedData_encrypt(encrypted, sizeof(encrypted));
    if (encryptedSz < 0)
        return -1;
