 ...
 * bundle which encapsulates an encryptedData content type. The encryptedData
 ...
 *
 * signedEncryptedFPD_noattrs.der - without example of optional attributes
 * signedEncryptedFPD_attrs.der   - with example of optional attributes
 */
...
#define encodedFileNoAttrs "signedEncryptedFPD_noattrs.der"
#define encodedFileAttrs   "signedEncryptedFPD_attrs.der"
                             ...
                             byte* out, word32 outSz)
{
    ...
    ret = wc_PKCS7_DecodeEncryptedData(pkcs7, pkcs7->content, pkcs7->contentSz,
                                       out, outSz);
    if (ret < 0) {
