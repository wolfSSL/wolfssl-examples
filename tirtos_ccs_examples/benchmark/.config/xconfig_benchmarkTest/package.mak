...
override PKGDIR = xconfig_benchmark
...
package/%.xdc.inc package/%_xconfig_benchmark.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_benchmark" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: benchmark.pem4f

-include package/cfg/benchmark_pem4f.mak
-include package/cfg/benchmark_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/benchmark_pem4f.dep
endif
benchmark.pem4f: package/cfg/benchmark_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
benchmark.pem4f package/cfg/benchmark_pem4f.c: .libraries,em4f
endif

package/cfg/benchmark_pem4f.c package/cfg/benchmark_pem4f.h package/cfg/benchmark_pem4f.xdl: override _PROG_NAME := benchmark.xem4f
package/cfg/benchmark_pem4f.c: package/cfg/benchmark_pem4f.cfg

clean:: clean,em4f
	-$(RM) package/cfg/benchmark_pem4f.cfg
	-$(RM) package/cfg/benchmark_pem4f.dep
	-$(RM) package/cfg/benchmark_pem4f.c
	-$(RM) package/cfg/benchmark_pem4f.xdc.inc

clean,em4f::
	-$(RM) benchmark.pem4f
.executables,em4f .executables: benchmark.xem4f

benchmark.xem4f: |benchmark.pem4f

-include package/cfg/benchmark.xem4f.mak
benchmark.xem4f: package/cfg/benchmark_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/benchmark_pem4f.oem4f   package/cfg/benchmark_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
benchmark.xem4f: export C_DIR=
benchmark.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
benchmark.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

benchmark.test test,em4f test: benchmark.xem4f.test

benchmark.xem4f.test:: benchmark.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 benchmark.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.benchmark.xem4f, ) 
endif

clean,em4f::
	-$(RM) .tmp,benchmark.xem4f,0,*
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
benchmark_pem4f.oem4f,copy : package/cfg/benchmark_pem4f.oem4f
benchmark_pem4f.sem4f,copy : package/cfg/benchmark_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_benchmark
xconfig_benchmark.tar: package/package.bld.xml
xconfig_benchmark.tar: package/build.cfg
xconfig_benchmark.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_benchmark.tar.dep
endif
package/rel/xconfig_benchmark/xconfig_benchmark/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_benchmark.tar: package/rel/xconfig_benchmark.xdc.inc package/rel/xconfig_benchmark/xconfig_benchmark/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_benchmark.xdc.inc,package/rel/xconfig_benchmark.tar.dep)


release release,xconfig_benchmark: all xconfig_benchmark.tar
clean:: .clean
	-$(RM) xconfig_benchmark.tar
	-$(RM) package/rel/xconfig_benchmark.xdc.inc
	-$(RM) package/rel/xconfig_benchmark.tar.dep
