...
;	c:\ti\ccsv6\tools\compiler\arm_5.1.6\bin\armopt.exe --call_assumptions=3 --gen_opt_info=2 C:\\Users\\khimes\\AppData\\Local\\Temp\\048162 C:\\Users\\khimes\\AppData\\Local\\Temp\\048164 --opt_info_filename=wolfssl/ctaocrypt/src/chacha.nfo 
;
