...
.dlls,em4f .dlls: cyassl_tirtos_benchmark.pem4f

-include package/cfg/cyassl_tirtos_benchmark_pem4f.mak
-include package/cfg/cyassl_tirtos_benchmark_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/cyassl_tirtos_benchmark_pem4f.dep
endif
cyassl_tirtos_benchmark.pem4f: package/cfg/cyassl_tirtos_benchmark_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
cyassl_tirtos_benchmark.pem4f package/cfg/cyassl_tirtos_benchmark_pem4f.c: .libraries,em4f
endif

package/cfg/cyassl_tirtos_benchmark_pem4f.c package/cfg/cyassl_tirtos_benchmark_pem4f.h package/cfg/cyassl_tirtos_benchmark_pem4f.xdl: override _PROG_NAME := cyassl_tirtos_benchmark.xem4f
package/cfg/cyassl_tirtos_benchmark_pem4f.c: package/cfg/cyassl_tirtos_benchmark_pem4f.cfg

clean:: clean,em4f
	-$(RM) package/cfg/cyassl_tirtos_benchmark_pem4f.cfg
	-$(RM) package/cfg/cyassl_tirtos_benchmark_pem4f.dep
	-$(RM) package/cfg/cyassl_tirtos_benchmark_pem4f.c
	-$(RM) package/cfg/cyassl_tirtos_benchmark_pem4f.xdc.inc

clean,em4f::
	-$(RM) cyassl_tirtos_benchmark.pem4f
.executables,em4f .executables: cyassl_tirtos_benchmark.xem4f

cyassl_tirtos_benchmark.xem4f: |cyassl_tirtos_benchmark.pem4f

-include package/cfg/cyassl_tirtos_benchmark.xem4f.mak
cyassl_tirtos_benchmark.xem4f: package/cfg/cyassl_tirtos_benchmark_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/cyassl_tirtos_benchmark_pem4f.oem4f   package/cfg/cyassl_tirtos_benchmark_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
cyassl_tirtos_benchmark.xem4f: export C_DIR=
cyassl_tirtos_benchmark.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
cyassl_tirtos_benchmark.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

cyassl_tirtos_benchmark.test test,em4f test: cyassl_tirtos_benchmark.xem4f.test

cyassl_tirtos_benchmark.xem4f.test:: cyassl_tirtos_benchmark.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 cyassl_tirtos_benchmark.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.cyassl_tirtos_benchmark.xem4f, ) 
endif

clean,em4f::
	-$(RM) .tmp,cyassl_tirtos_benchmark.xem4f,0,*


clean:: clean,em4f

clean,em4f::
	-$(RM) cyassl_tirtos_benchmark.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
cyassl_tirtos_benchmark_pem4f.oem4f,copy : package/cfg/cyassl_tirtos_benchmark_pem4f.oem4f
cyassl_tirtos_benchmark_pem4f.sem4f,copy : package/cfg/cyassl_tirtos_benchmark_pem4f.sem4f
