...
wolfssl_tirtos_benchmark.obj: ../wolfssl_tirtos_benchmark.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: ARM Compiler'
	"c:/ti/ccsv6/tools/compiler/arm_5.1.6/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me -O3 --opt_for_speed=5 --include_path="C:/wolfssl" --include_path="C:/ti/ndk_2_24_00_05_eng/packages/ti/ndk/inc" --include_path="C:/ti/ndk_2_24_00_05_eng/packages/ti/ndk/inc/bsd" --include_path="c:/ti/ccsv6/tools/compiler/arm_5.1.6/include" --include_path="c:/ti/tirtos_tivac_2_00_02_36/products/TivaWare_C_Series-2.1.0.12573c" -g --gcc --define=PART_TM4C1294NCPDT --define=TIRTOS --define=ccs --define=TIVAWARE --define=_INCLUDE_NIMU_CODE --define=NO_MAIN_DRIVER --define=BENCH_EMBEDDED --define=HAVE_ECC --define=WOLFSSL_SHA512 --define=HAVE_CHACHA --define=HAVE_POLY1305 --define=HAVE_CAMELLIA --display_error_number --diag_warning=225 --diag_wrap=off --gen_func_subsections=on --optimizer_interlist --remove_hooks_when_inlining --opt_for_cache --gen_opt_info=2 --call_assumptions=3 --auto_inline=5 --single_inline --aliased_variables --preproc_with_compile --preproc_dependency="wolfssl_tirtos_benchmark.pp" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '

configPkg/linker.cmd: ../wolfssl_tirtos_benchmark.cfg
	@echo 'Building file: $<'
