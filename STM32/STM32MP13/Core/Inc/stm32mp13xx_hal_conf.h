...
#define ETH_MAC_ADDR0    (0x00UL)  //(0x02UL)
#define ETH_MAC_ADDR1    (0x80UL)  //(0x00UL)
#define ETH_MAC_ADDR2    (0xE1UL)  //(0x00UL)
#define ETH_MAC_ADDR3    (0x00UL)  //(0x00UL)
#define ETH_MAC_ADDR4    (0x00UL)  //(0x00UL)
#define ETH_MAC_ADDR5    (0x00UL)  //(0x00UL)
